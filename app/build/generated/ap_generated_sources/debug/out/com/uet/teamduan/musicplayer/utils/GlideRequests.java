...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.uet.teamduan.musicplayer.utils.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.uet.teamduan.musicplayer.utils.GlideOptions().apply(toSet));
    }
  }
}
